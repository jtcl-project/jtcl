...
public class AppShell {
	...
	/**
	 * The attribute in META-INF/MANIFEST.MF denoting the resource file to execute.
	 */
	...
	public static void main(String args[]) {
		Manifest mf;
		try {
			InputStream inputStream = AppShell.class.getClassLoader().getResourceAsStream("META-INF/MANIFEST.MF");
		...
		String fileName = mf.getMainAttributes().getValue(JTCL_MAIN);
		if (fileName == null) {
